...
public class StringUtil {
	...
	public static int arrayFill(byte[] abyte0, int offSet, int padLength,
			byte byte0) {
		while (padLength-- > 0) {
			abyte0[(offSet++)] = byte0;
		}
	...
	public static byte binaryToByte(String binary) throws StringFormatException {
		if (binary.length() != 8) {
	...
	public static String bufferShortToHexWithOutHigh(short[] buffer, int start,
			int end) {
		StringBuilder res = new StringBuilder();
		for (int i = start; i < end; i++) {
	...
	public static int cmp(byte[] abyte0, int arrayOneStart, byte[] abyte1,
			int arrayTwoStart, int arrayLength) {
		int l = 0;
	...
	public static byte[] hexToBuffer(String hex) throws StringFormatException {
	...
	public static byte hexToByte(String hex) throws StringFormatException {
		byte res = 0;
	...
	public static int hexToInt(String hex) throws StringFormatException {
		if (hex.length() != 8) {
	...
	public static short hexToShort(byte[] hex) throws StringFormatException {
		return hexToShort(bufferToHex(hex));
	}

	public static short hexToShort(char[] hex) throws StringFormatException {
		return hexToShort(bufferCharToHexWithOutHigh(hex));
	}

	public static short hexToShort(String hex) throws StringFormatException {
		if (hex.length() != 4) {
	...
	public static String[] splitStrWithLength(String dealStr, int splitNum) {
		...
		try {
			...
			tempStr = dealStr.substring(index, dealStr.length());
			tempList.add(tempStr);
