...
public class MnoES4Test {
	...
	private static final String _url = "http://localhost:8080/euicc-webservice-mock/webservice/ES4MnoService?wsdl";
	...
	/*public static void main(String args[]) throws java.lang.Exception {
		...
		ES4HandleProfileDisabledNotification _parameters = new ES4HandleProfileDisabledNotification();
		_parameters.setEid("123456".getBytes());
		_parameters.setIccid("00");
		_parameters.setCompletionTimestamp(processTime);
		port.es4HandleProfileDisabledNotification(_parameters);

	}*/
	
	@Test
	public void es4HandleSMSRChangeNotificationTest()throws java.lang.Exception {
		...
		System.out.println("Invoking es4HandleSMSRChangeNotificationTest...");
		ES4HandleSMSRChangeNotification _parameters = new ES4HandleSMSRChangeNotification();
		_parameters.setEis(setEIS());
		_parameters.setCompletionTimestamp(call);
		port.es4HandleSMSRChangeNotification(_parameters);
	}
...
//		eis.setAvailableMemoryForProfiles(value);
	...
	@Test
	public void es4HandleProfileDisabledNotificationTest()throws java.lang.Exception {
		URL wsdlURL = new URL(_url);
		ES4MnoService ss = new ES4MnoService(wsdlURL, SERVICE_NAME);
		ES4Mno port = ss.getMnoES4Port();
		XMLGregorianCalendar call = DatatypeFactory.newInstance().newXMLGregorianCalendar(new GregorianCalendar());
	...
	@Test
	public void es4HandleProfileEnabledNotificationTest()throws java.lang.Exception {
		URL wsdlURL = new URL(_url);
		ES4MnoService ss = new ES4MnoService(wsdlURL, SERVICE_NAME);
		ES4Mno port = ss.getMnoES4Port();
		XMLGregorianCalendar call = DatatypeFactory.newInstance().newXMLGregorianCalendar(new GregorianCalendar());
		...
		ES4HandleProfileEnabledNotification _parameters = new ES4HandleProfileEnabledNotification();
		_parameters.setEid("89001012012341234012345678901224".getBytes());
		_parameters.setIccid("00");
		_parameters.setCompletionTimestamp(call);
		port.es4HandleProfileEnabledNotification(_parameters);
	}

	@Test
	public void es4HandleProfileDeletedNotificationTest()throws java.lang.Exception {
		URL wsdlURL = new URL(_url);
		ES4MnoService ss = new ES4MnoService(wsdlURL, SERVICE_NAME);
		ES4Mno port = ss.getMnoES4Port();
		XMLGregorianCalendar call = DatatypeFactory.newInstance().newXMLGregorianCalendar(new GregorianCalendar());
		...
		ES4HandleProfileDeletedNotification _parameters = new ES4HandleProfileDeletedNotification();
		_parameters.setEid("89001012012341234012345678901224".getBytes());
		_parameters.setIccid("00");
		_parameters.setCompletionTimestamp(call);
		port.es4HandleProfileDeletedNotification(_parameters);
	}
}
