...
/**
 * @ClassName BindTransmitterMain
 * @author Administrator
 * @date 2017-1-23 下午3:23:32
 * @Description TODO(这里用一句话描述这个类的作用)
 */
public class BindTransmitterMain {
	...
	public static void main(String[] args) {
		BindTransmitterMain client = new BindTransmitterMain();
		client.bind();
		client.service();
	}
	
	public BindTransmitterMain() {
		...
		session = new BasicSession(conn, "bindTransmitter");
		session.setSmscResponseTimeout(60000);
		session.setEnquireLinkTimeout(180000);
