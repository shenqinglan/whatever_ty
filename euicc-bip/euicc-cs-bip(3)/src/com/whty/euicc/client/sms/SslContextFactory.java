...
public class SslContextFactory {
	...
	static {
		...
		try {
			...
			ks.load(SslContextFactory.class.getResourceAsStream("android.bks"), keyStorePassword.toCharArray());
			...
			ts.load(SslContextFactory.class.getResourceAsStream("android.bks"), keyStorePassword.toCharArray());
