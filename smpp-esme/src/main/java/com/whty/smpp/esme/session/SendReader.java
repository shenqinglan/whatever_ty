 ...
 * Id: SendReader.java,v 1.0 2017-2-10 上午9:50:17 Administrator
 */
...
/**
 * @ClassName SendReader
 * @author Administrator
 * @date 2017-2-10 上午9:50:17
 * @Description TODO(这里用一句话描述这个类的作用)
 */
public class SendReader  implements Reader {
	
	private static Logger logger = LoggerFactory.getLogger(SendReader.class);

	protected DataInputStream is;
	private final ISmppPduTranscoder transcoder;

	public SendReader(InputStream is, ISmppPduTranscoder transcoder) {
	...
	public Message read() throws IOException {
		...
		if (packetLen[3] == -1) {
			logger.info("read send message empty");
			return null;
		}
