...
/**
 * 
 * @ClassName SendWriter
 * @author Administrator
 * @date 2017-3-10 下午1:39:44
 * @Description TODO(这里用一句话描述这个类的作用)
 */
public class SendWriter implements Writer {

	private static Logger logger = LoggerFactory.getLogger(SendWriter.class);

	protected DataOutputStream out;
	private final ISmppPduTranscoder transcoder;
	private final SequenceNumber sequenceNumber;

	public SendWriter(OutputStream os, ISmppPduTranscoder transcoder,
