...
import com.whty.smpp.socket.transcoder.ISmppPduTranscoderContext;
import com.whty.smpp.socket.util.ChannelBufferUtil;
/**
 * 
 * @ClassName Pdu
 * @author Administrator
 * @date 2017-3-10 下午1:46:17
 * @Description TODO(这里用一句话描述这个类的作用)
 */
public abstract class Pdu implements Message{
     ...
     * @see Pdu#setOptionalParameter(com.whty.smpp.pojo.smpp.tlv.Tlv)
     */
    ...
    public void readOptionalParameters(ChannelBuffer buffer, ISmppPduTranscoderContext context) throws UnrecoverablePduException, RecoverablePduException {
    ...
    public void writeOptionalParameters(ChannelBuffer buffer, ISmppPduTranscoderContext context) throws UnrecoverablePduException, RecoverablePduException {
        if (this.optionalParameters == null) {
            return;
        }
        for (Tlv tlv : this.optionalParameters) {
