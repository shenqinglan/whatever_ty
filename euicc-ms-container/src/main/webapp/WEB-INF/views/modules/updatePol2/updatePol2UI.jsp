...
<!--<![endif]-->
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<%@ include file="updatePol2List.jsp"%>
					<!-- your code here end-->
				</div>
			</div>
			<%@ include file="updatePol2Edit.jsp"%>
			<%@ include file="pol2Table.jsp"%>
			<%@ include file="selectPol2Table.jsp"%>
			<!-- END CONTENT -->
		</div>
		...
		<script src="${ctxResources}/pages/scripts/updatePol2/updatePol2UI.js"></script>
		<script >
