...
<!--<![endif]-->
	...
	<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
    	...
    	<link rel="stylesheet" href="${ctxResources}/pages/css/scp.css"/>
	</head>
	<body class="page-header-fixed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<%@ include file="euiccCardList.jsp"%>
					<!-- your code here end-->
				</div>
			</div>
			<%@ include file="euiccCardEdit.jsp"%>
			<%@ include file="scp03Edit.jsp"%>
			<%@ include file="scp80Edit.jsp"%>
			<%@ include file="scp81Edit.jsp"%>
			<%@ include file="isdpEdit.jsp"%>
			<%@ include file="scp80Table.jsp"%>
			<%@ include file="scp81Table.jsp"%>
			<%@ include file="scp03Table.jsp"%>
			<%@ include file="isdpTable.jsp"%>
			<!-- END CONTENT -->
		</div>
		...
		<script src="${ctxResources}/global/scripts/ajaxfileupload.js"></script>
		<script src="${ctxResources}/pages/scripts/euiccCard/euiccCardUI.js"></script>
		<script language="javascript" type="text/javascript" src="${ctxResources}/My97DatePicker/WdatePicker.js"></script>
		<script >
