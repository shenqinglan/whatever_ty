...
<!--<![endif]-->
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<%@ include file="profileSmsMgrList.jsp"%>
					<!-- your code here end-->
				</div>
			</div>
			<%@ include file="profileSmsMgrEdit.jsp"%>
			<%@ include file="profileSmsTable.jsp"%>
			<!-- END CONTENT -->
		</div>
		...
		<script src="${ctxResources}/pages/scripts/profileSmsMgr/profileSmsMgrUI.js"></script>
		<script >
