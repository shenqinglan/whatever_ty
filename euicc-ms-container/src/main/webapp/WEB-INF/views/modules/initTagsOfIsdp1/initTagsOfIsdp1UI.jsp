...
<!--<![endif]-->
	...
	<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
    	...
    	<link rel="stylesheet" href="${ctxResources }/pages/css/getstatus.css"/>
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<%@ include file="initTagsOfIsdp1List.jsp"%>
					<!-- your code here end-->
				</div>
			</div>
			<%@ include file="initTagsOfIsdp1Edit.jsp"%>
			<%@ include file="initTagsOfIsdp1Table.jsp"%>
			<!-- END CONTENT -->
		</div>
		...
		<script src="${ctxResources}/pages/scripts/initTagsOfIsdp1/initTagsOfIsdp1UI.js"></script>
		<script >
