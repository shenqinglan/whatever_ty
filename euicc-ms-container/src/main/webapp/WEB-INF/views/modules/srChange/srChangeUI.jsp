...
<!--<![endif]-->
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<%@ include file="srChangeList.jsp"%>
					<!-- your code here end-->
				</div>
			</div>
			<%@ include file="srChangeEdit.jsp"%>
			<%@ include file="srChangeTable.jsp"%>
			<!-- END CONTENT -->
		</div>
		...
		<script src="${ctxResources}/pages/scripts/srChange/srChangeUI.js"></script>
		<script >
