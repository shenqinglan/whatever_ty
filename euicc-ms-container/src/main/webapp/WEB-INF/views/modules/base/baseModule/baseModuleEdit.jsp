						...
						<form class="form-horizontal" id="moduleForm" role="form">
							<div class="form-body">
								...
								<div class="form-group">
									<label class="col-md-4 control-label">节点类型<span class="required">*</span></label>
									<div class="col-md-8">
								...
								<div class="form-group">
									<label class="col-md-4 control-label">菜单编码<span class="required">*</span></label>
									<div class="col-md-8">
									<div class="input-icon right">
										<i class="fa"></i>
								...
								<div class="form-group" id="urlDiv">
									<label class="col-md-4 control-label">菜单URL<span id="moduleForm_moduleUrl_span" class="required">*</span></label>
									<div class="col-md-8">
									<div class="input-icon right">
										<i class="fa"></i>
								...
								<div class="form-group" id="parIdDiv">
									<label class="col-md-4 control-label">父级菜单<span class="required">*</span></label>
									<div class="col-md-8">
									<div class="input-icon right">
										<i class="fa"></i>
								...
								<div class="form-group">
									<label class="col-md-4 control-label">CSS样式</label>
									<div class="col-md-8">
									<div class="input-icon right">
										<i class="fa"></i>
								...
								<div class="form-group">
									<label class="col-md-4 control-label">菜单说明</label>
									<div class="col-md-8">
									<div class="input-icon right">
										<i class="fa"></i>
