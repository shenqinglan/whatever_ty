...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	...
	<body class="page-header-fixed">
		...
		function getPremission(data){
			var p = "<shiro:hasPermission name='baseFields:edit'><a class='btn default edit btn-xs blue' name='"+data+"'><i class='fa fa-edit'></i>编辑 </a></shiro:hasPermission>";
			p += "<shiro:hasPermission name='baseFields:delete'><a class='btn default delete btn-xs red' name='"+data+"'><i class='fa fa-trash-o'></i>删除</a></shiro:hasPermission>";
			return p;
		}	
		</script>
	</body>
