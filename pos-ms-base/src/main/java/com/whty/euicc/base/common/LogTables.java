...
//        if (condition != null && !"".equals(condition)) {
    ...
    public static String setShowValue(String value, String type) {
        if (Constant.POS_BASE_TYPE.equalsIgnoreCase(type)) {
            return baseMap.get(value);
        }
        else if (Constant.POS_CARD_TEST_TYPE.equalsIgnoreCase(type)) {
            return cardTestStatusMap.get(value);
        }
        else if (Constant.POS_OP_AP_TYPE.equalsIgnoreCase(type)) {
            return apStatusMap.get(value);
        }
        else if (Constant.POS_OP_APP_TYPE.equalsIgnoreCase(type)) {
            return appStatusMap.get(value);
        }
        else if (Constant.POS_OP_APPVER_TYPE.equalsIgnoreCase(value)) {
