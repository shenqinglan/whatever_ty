 ...
 * @version 2017-02-17
 */
public class GAHighFrequencySubscriber {

	public static final String HOST = "tcp://118.178.95.186:1883";
	public static final String TOPIC1 = "87d5bd3767e841799a2de1501a634230/v1/ap/+/heartbeat";
	...
	public void start() {
		try {
			GaDeviceAp ap = new GaDeviceAp();
			ap.setStatus("3");
			GaDeviceApDao.update(ap);
			...
			client.disconnect();
			client.close();
			GaDeviceAp apa = new GaDeviceAp();
			apa.setStatus("2");
			GaDeviceApDao.updateToFail(apa);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
