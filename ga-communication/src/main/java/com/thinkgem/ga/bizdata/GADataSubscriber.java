 ...
 * @version 2017-02-17
 */
public class GADataSubscriber {

    public static final String HOST = "tcp://118.178.95.186:1883";
    public static final String TOPIC = "87d5bd3767e841799a2de1501a634230/v1/ms/+/reportuploadData";
    ...
    public void start() {
        try {
            ...
            // 设置回调
            client.setCallback(new GADataPushCallback());
