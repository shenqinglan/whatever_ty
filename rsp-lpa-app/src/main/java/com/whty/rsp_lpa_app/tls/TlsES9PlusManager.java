...
public class TlsES9PlusManager {
	
	private static TlsES9PlusManager instance;
	private String type = "application/json";
	private String initiateAuthenticationPath = "/gsma/rsp2/es9plus/smdp/initiateAuthentication";
	private String authenticateClientPath = "/gsma/rsp2/es9plus/smdp/authenticateClient";
	private String cancelSessionPath = "/gsma/rsp2/es9plus/smdp/cancelSession";
	private String getBoundProfilePackagePath = "/gsma/rsp2/es9plus/smdp/getBoundProfilePackage";
	private String handleNotificationPath = "/gsma/rsp2/es9plus/smdp/handleNotification";
	
	public static TlsES9PlusManager getInstance() {
		if (instance == null) {
			instance = new TlsES9PlusManager();
		}
		return instance;
	}
