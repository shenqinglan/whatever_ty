...
import com.whty.efs.packets.message.request.attr.WithSeID_MsgBody;

/**
 * 银数手机客户端申请
 * @ClassName: AppApplyReqBody
 * @author: xuliping@whty.com.cn
 * @since:2015年12月24日
 * @Description:TODO
 */
@MsgType("tath.112.002.01")
public class AppApplyBody extends RequestMsgBody implements WithSeID_MsgBody,WithAppAidVersion_MsgBody{
