 ...
 * @date 2017-2-21 上午9:50:27
 * @Description TODO(回调式订阅消息)
 */
public class CallbackSubscribe {
	public static void main(String[] args) {
		try {
			MQTT mqtt = new MQTT();

			// MQTT设置说明
			mqtt.setHost("tcp://118.178.95.186:1883");
			...
			callbackConnection.connect(new Callback<Void>() {
				...
				public void onSuccess(Void v) {
					...
					// 发布消息
					callbackConnection.publish("87d5bd3767e841799a2de1501a634230/v1/ap/FFFF0048/heartbeat", ("Hello ").getBytes(),
