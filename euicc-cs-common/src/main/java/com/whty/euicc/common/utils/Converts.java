...
//import com.whty.tsm.common.constant.Constant ;
//import com.whty.tsm.common.utils.Converts;
...
public abstract class Converts {
     ...
     */
    public static byte[] ucs2Encode(String src) throws UnsupportedEncodingException {
     ...
     * @throws java.io.UnsupportedEncodingException ***************************************************************
     */
    public static boolean isAcsiiEncode(String src) throws UnsupportedEncodingException {
        if (src == null || src.length() == 0) {
            return false;
        }
