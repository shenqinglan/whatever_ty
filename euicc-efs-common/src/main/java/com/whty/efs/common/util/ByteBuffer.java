...
import com.whty.efs.common.exception.NotEnoughDataException;
import com.whty.efs.common.exception.TerminatingZeroNotFoundException;
...
public class ByteBuffer
{
    ...
    public void appendString(String str, int xtype, int length)
    {
        if (str == null)
        {
            str = "";
