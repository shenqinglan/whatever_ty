...
/**
 * Change第一条store data的apdu拼装
 * @author zyj
 *
 */
@Service
public class CertSrEcdsaApdu {
	
	private Logger logger = LoggerFactory.getLogger(CertSrEcdsaApdu.class);
...
//	private final String STORE_Le = "00";
	
	private final String DGI = "3A01";
	private final String TAG_93 = "930101";
	private final String TAG_42 = "420101";
	private final String TAG_5F20 = "5F200101";
	private final String TAG_95 = "950188";
	//private final String TAG_5F25 = "5F25 04 20 10 01 01";
	private final String TAG_5F24 = "5F240421450101";
	private final String TAG_73 = "7303C80102";
...
//	private final String TAG_5F37 = "5f375F8FB981D078662BBA38F22F4041AC8299B6869F724545FDCF0C2B8B575AE8EC3D6A12E2ADAB160646266CEEA067BAEFBFB4899A5F71162B56770C63D029236D";//todo
...
//	private final String D_CI_ECDSA="CCF97608A5081B8F478FBAB00CFE6F5A50B1C23C4B42E95EFFDDFB2DD1AD6676";
	...
	private final String D_CI_ECDSA = SpringPropertyPlaceholderConfigurer.getStringProperty("D_CI_ECDSA");
	
	public byte[] firstStoreDataApdu() {
		...
		logger.info("first store_data SM-SR Change的APDU指令为:{}",finalApdu.toString());
