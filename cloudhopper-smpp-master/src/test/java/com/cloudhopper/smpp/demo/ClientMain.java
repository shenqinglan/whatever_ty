...
public class ClientMain {
    ...
    static public void main(String[] args) throws Exception {
        ...
        config0.setSystemId("333");
        config0.setPassword("0555");
        ...
        try {
            ...
            String text161 = "\u20AC Lorem [ipsum] dolor sit amet, consectetur adipiscing elit. Proin feugiat, leo id commodo tincidunt, nibh diam ornare est.";
            byte[] textBytes1 = CharsetUtil.encode(text161, CharsetUtil.CHARSET_GSM);
            
            SubmitSm submit1 = new SubmitSm();

            // add delivery receipt
            submit1.setRegisteredDelivery(SmppConstants.REGISTERED_DELIVERY_SMSC_RECEIPT_REQUESTED);

            submit1.setSourceAddress(new Address((byte)0x03, (byte)0x00, "40404"));
            submit1.setDestAddress(new Address((byte)0x01, (byte)0x01, "44555519205"));
            submit1.setShortMessage(textBytes1);
            SubmitSmResp submitResp1 = session0.submit(submit0, 30000);
