...
<!--<![endif]-->
	...
	<body class="page-header-fixed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<%@ include file="deviceApproveList.jsp"%>
					<%@ include file="deviceApproveEdit.jsp"%>
		...
		<script src="${ctxResources}/pages/scripts/deviceApprove/deviceApproveUI.js"></script>
		<script >
