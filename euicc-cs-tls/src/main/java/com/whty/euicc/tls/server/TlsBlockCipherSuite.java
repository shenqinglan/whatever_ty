...
import wq.app.crypto.BlockCipher;
import wq.app.crypto.Digest;
import wq.app.crypto.digests.SHA1Digest;
import wq.app.crypto.digests.SHA256Digest;
import wq.app.crypto.macs.HMac;
import wq.app.crypto.params.KeyParameter;
import wq.app.crypto.params.ParametersWithIV;
import wq.app.crypto.tls.TlsFatalAlert;
import wq.security.SecureRandom;
  ...
  extends TlsCipherSuite
{
	...
	private TlsMac1 writeMac;
	private TlsMac1 readMac;
	...
	public void init(byte[] ms, byte[] cr, byte[] sr, short majorVersion, short minorVersion)
	{
		...
		writeMac = new TlsMac1(writeDigest, key_block, offset, writeDigest
		...
		readMac = new TlsMac1(readDigest, key_block, offset, readDigest
		  .getDigestSize(), majorVersion, minorVersion);
