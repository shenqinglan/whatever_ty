 ...
 *
 */
public class HttpsClient extends  HttpsBase {  
    ...
    public static void callSr(String str)throws Exception{
    	callClient(str,8090);
    }
    
    public static void callDp(String str)throws Exception{
    	callClient(str,8091);
    }
    
    public static void callClient(String str,int port) throws  Exception{  
        //int port=8090;  
